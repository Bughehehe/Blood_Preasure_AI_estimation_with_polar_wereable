...
for i in range(max_length):
    ...
    ECG_data_window['ecg [uV]'] = ECG_data_window['ecg [uV]'].rolling(window=FILTERED_WINDOW, min_periods=1).mean()
    ...
    PPG_data_window['main_channel'] = PPG_data_window['main_channel'].rolling(window=FILTERED_WINDOW, min_periods=1).mean()
